...
document.getElementById("input").addEventListener("keydown", function(event) {
    if (event.key === "Enter") {
        ...
        if (command === "help") {
            ...
            output.innerHTML += `<div>My names Livid, I do Reversing, Python, patching, Malware analysis, and cyber sec </div>`;
        } else if (command === "contact") {
            output.innerHTML += `<div>You can contact me on discord at: <span style="color: #00ff00;">lividbe</span></div>`;
        } else if (command === "projects") {
            output.innerHTML += `<div>Lunar client injectable, and cware r6s<br>`;
